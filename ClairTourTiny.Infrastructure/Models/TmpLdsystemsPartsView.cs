...
public partial class TmpLdsystemsPartsView
{
    ...
    public string? ClaudeReasoningSteps { get; set; }

    public string? ClaudeSuggestedPartno { get; set; }

    public byte? ClaudeSuggestedPartnoConfidence { get; set; }

    public string? ClaudeAutoPartSearchAnalysis { get; set; }

    public string? ClaudeSuggestedPartAssessment { get; set; }

    public string? ClaudeAdditionalInformationWanted { get; set; }
}
