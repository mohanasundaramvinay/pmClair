...
public partial class Rfi
{
    ...
    public virtual Glentity InvEntitynoNavigation { get; set; } = null!;

    public virtual ICollection<InvoicePiece> InvoicePieces { get; set; } = new List<InvoicePiece>();

    public virtual InvoiceSeries? InvoiceSeries { get; set; }

    public virtual InvoiceSeriesGroup? InvoiceSeriesGroup { get; set; }

    public virtual ICollection<Pjempassign> PjempassignRfiNavigations { get; set; } = new List<Pjempassign>();

    public virtual ICollection<Pjempassign> PjempassignRfis { get; set; } = new List<Pjempassign>();

    public virtual Pjinvratetype RatetypeNavigation { get; set; } = null!;

    public virtual Company? RevenueCompanyNavigation { get; set; }
}
